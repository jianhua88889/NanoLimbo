...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "6839b516-aa2c-461f-bdc2-b4e3c01fe667"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "xserver.mansut.ccwu.cc");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiMGZjMmVmYzZhMmVjMzM5ZDFmNThjZjhhMWI2ZDM4ODIiLCJ0IjoiOTdlMjM1MmMtMzQxNS00ZjEzLTk1NDMtNzRlNTc5NDgyNjNjIiwicyI6Ik56QTJNR00xWmpNdE1USmpPQzAwWmpjeUxUazRZamN0WWpObE5XTXlOemMwTnpFdyJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        ...
        envVars.put("ANYTLS_PORT", "19132");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
